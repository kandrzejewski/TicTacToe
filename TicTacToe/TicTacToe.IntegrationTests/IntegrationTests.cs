...
namespace TicTacToe.IntegrationTests
{
    public class IntegrationTests
    {
        ...
        {
            string applicationBasePath = Path.GetFullPath(Path.Combine(
        ...
        public async Task ShouldGetHomePageAsync()
        {
            ...
            Assert.Contains("Witamy w grze komputerowej w Kółko i krzyżyk!", responseString);
        }
